...
{
	protected const int windowPriority = 45;
	protected const int createPriority = 10;
	protected const int assetPriority = 1000000;
	protected const int corePriority = createPriority + 0;
	protected const int audioPriority = createPriority + 1;
	protected const int streamPriority = createPriority + 2;
	protected const int visPriority = createPriority + 3;
	protected const int completePriority = createPriority + 4;
	protected const int devPriority = createPriority + 5;

	protected const string createMenuRootPath = "GameObject/Procedural Worlds/SECTR/";
	protected const string assetMenuRootPath = "Assets/Create/Procedural Worlds/SECTR ";
	protected const string windowMenuRootPath = "Window/Procedural Worlds/SECTR/";
