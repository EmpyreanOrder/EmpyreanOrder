...
public class SECTR_Hibernator : MonoBehaviour 
{
	...
	void _ChunkChanged(SECTR_Chunk source, SECTR_Chunk.LoadState loadState)
	{
		if(loadState == SECTR_Chunk.LoadState.Loaded)
		{
			++numLoadedSectors;
		}
		else if(loadState == SECTR_Chunk.LoadState.Unloaded)
		{
			--numLoadedSectors;
		}
